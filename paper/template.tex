...
These analysis are done over both ATCOR and FLAASH data with SVM polynomial degree of 3 and RBF ($C = +\infty, \sigma=10^4$); the parameters were chosen using a mix of grid search and heuristic optimization. 
Cost of $\infty$ means that we have little to zero tolerance for improperly classified samples.
...
\begin{figure}[tp]
  % Fixed length
  \centering
  \subcaptionbox{Before removing water absorption bands\label{fig:before removing wab}}{\includegraphics[height=2.5in,keepaspectratio]{./images/before-removing-wab.eps}}
  \subcaptionbox{After removing water absorption bands\label{fig:after removing wab}}{\includegraphics[height=2.5in,keepaspectratio]{./images/gaussian_window.eps}}\hspace{1em}%
    \subcaptionbox{After removing low NDVI NIR pixels\label{fig:after removing NDVI NIR}}{\includegraphics[height=2.5in,keepaspectratio]{./images/after-removing-ndvi-nir.eps}}\hspace{1em}%
...
\begin{figure}[tp]
  % Fixed length
  \centering
  \subcaptionbox{Tuning polynomial order for SVM with polynomial kernel function\label{fig:parameter tuning:poly}}{\includegraphics[height=2.5in,keepaspectratio]{./images/poly.eps}}\hspace{1em}%
  \subcaptionbox{Tuning $\sigma$ in SVM with RBF kernel function\label{fig:parameter tuning:RBF}}{\includegraphics[height=2.5in,keepaspectratio]{./images/rbf.eps}}
...
\begin{figure}[tp]
  ...
  \centering
    \subcaptionbox{After removing low NDVI NIR pixels\label{fig:after removing NDVI NIR}}{\includegraphics[height=2.5in,keepaspectratio]{./images/after-removing-ndvi-nir.eps}}\hspace{1em}%
    \subcaptionbox{Generic 2/3 vs 1/3 train and test sets. Asserting non-overfitting SVM model\label{fig:13 23}}{\includegraphics[height=2.5in,keepaspectratio]{./images/F-svm-13-23.eps}}\hspace{1em}%
