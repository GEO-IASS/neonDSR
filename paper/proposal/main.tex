...
\documentclass[12pt,final,CPage]{ufthesis} %Use this line for Macintosh/Linux OS
...
\SetThesisType{Dissertation Proposal}%{Tutorial}% %{Thesis}
...
\SetTitle{Applying Big Data Technology to Remote Sensing for Species Identification}
...
%\dedication{\input{frontmatter/dedication}} % %Creates the dedication - if your dedication is more than a single line
...
%\include{frontmatter/acknowledgements} % % % %Required - There is no requirement to acknowledge a particular person
...
\include{frontmatter/TOC} %This file creates the Table of Contents, List of Figures, and List of Objects (if any)
...
\phantomsection
\include{frontmatter/abstract} %The abstract is created using this file and userinfo.tex
...
%\include{appendix/appendix2} %Use this file if you have two or more appendices

%\include{appendix/appendix1} %Use this file if you have one and only one appendix
...
\bibliography {bib/dissrefs} %{bib/sample,bib/dissrefs,bib/jzthesis,bib/taco}
