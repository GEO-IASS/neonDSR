...
CREATE TABLE `specie` (
  ...
  `max_dbh` float NOT NULL,
  `max_crown` float NOT NULL,
  `successional_level` float NOT NULL,
  `shade_tolerance_level` float NOT NULL,
...
INSERT INTO `specie` VALUES (1,'Turkey Oak',1,25,0.66,20,2,0.5),(2,'Longleaf Pine',1,37,1,16,1,0);
