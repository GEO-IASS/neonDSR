function [LogLikelihoodTrace, SampleTrace, ClusterResults] = PCE_Sample_1cluster(X, Parameters)
...
LogLikelihoodTrace  = zeros(Parameters.NumInitalSampleTraceLocations,Parameters.NumberIterations+1);
