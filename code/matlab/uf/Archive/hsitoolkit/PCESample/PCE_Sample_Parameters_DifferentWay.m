function [Parameters] = PCE_Sample_Parameters_DifferentWay(X)
...
Parameters.ECovariance = .01; %Currently diagonal co-variance, same for all endmembers
...
Parameters.VarianceEndmemberSampleNarrow = (.001/var(X(:)))*mean(D(2,:))^2;
...
Parameters.Innovation = Parameters.NumESamples./(size(X,1)*100);
...
for i = 1:InitialNumberOfClusters
    ...
    Parameters.beta = (var(X(:))/.001)*250*mean(v(:)); %scale on the sampled covariance matrix
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
